...
description: "NestJS architecture patterns and best practices.\nTRIGGER when: planning or implementing NestJS features (modules, services, controllers, guards, pipes, interceptors, etc.), designing module, implementing auth/security, or writing NestJS tests.\nDO NOT TRIGGER when: only reading NestJS code without intent to modify or asking general TypeScript/Node.js questions."
license: MIT
metadata:
  author: Kadajett
  version: "1.1.0"
...
- Working on frontend code (Next.js, React components) even if it consumes NestJS API
