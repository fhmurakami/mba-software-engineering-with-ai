...
This keep controllers thin and error handling centralized.
...
- Services throw NestJS built-in exceptions (`NotFoundException`, `ConflictException`, etc.) and exception filters convert them to HTTP responses
