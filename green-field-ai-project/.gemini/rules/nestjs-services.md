...
### Request lifecycle (services invoked by controllers)
...
- Loggin inside a catch is fine, but logging is not a substitute for throwing

### Background tasks, event handlers and cron jobs
